...
use App\Filament\Learner\Resources\LearnerOrderResource\Pages;
...
class LearnerOrderResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('amount_paid')->money('NGN')->sortable(),
    ...
    {
        return [
            'index' => Pages\ListLearnerOrders::route('/'),
        ];
    }
}
